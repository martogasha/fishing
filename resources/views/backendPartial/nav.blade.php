...
<!-- Mirrored from thememinister.com/crm/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jul 2020 08:34:00 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <li>
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#" class="border-gray">
                                            <div class="pull-left">
                                                <img src="asset/dist/img/avatar4.png" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>Salman</h4>
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-users"></i><span>Stock</span>
                        <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('addStock')}}">Add Stock</a></li>
                        <li><a href="{{url('stock')}}">List</a></li>
                        </ul>
                </li>
            </ul>
        </div>
