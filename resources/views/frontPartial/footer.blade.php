<footer class="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="contact-widget email">
                                    ...
                                    <a href="mailto:mail@example.com">fredrickokumu79@yahoo.com</a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-widget">
                                    <h4 class="widget-title">PHONE</h4>
                                    <a href="#">+254713196983</a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-widget">
    ...
    <div class="footer-bottom">
        <div class="container top-border d-flex align-items-center justify-content-between flex-wrap">
            <p class="footer-copyright mb-0 py-3 pr-3">FredFishingFlies. &copy;  2021.  All Rights Reserved</p>
